/*
  ...
  1. New Tables
    - `ai_conversations`
      ...
      - `title` (text) - Name of the conversation
      - `context` (jsonb) - Optional context (quote_id, customer_id, etc.)
    ...
    - `ai_messages`
      ...
      - `data` (jsonb) - Optional structured data (query results)
      - `sql` (text) - Optional SQL query that was executed
      - `created_at` (timestamptz)
  ...
  3. Indexes
    - Index on user_id for fast conversation lookups
